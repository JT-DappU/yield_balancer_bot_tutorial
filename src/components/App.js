               ...
               <div class="card m-5 mx-auto col-8">
                  ...
                  <div class="card-body">
                    ...
                    <div class="web3_found d-none">
                      ...
                      <a href="#" class="btn btn-primary">Connect to App</a>
                    </div>

                    {/* Web3 Connected */}
                    <div class="web3_connected d-none">
                      <p class="alert alert-success">12345 DAI Available</p>
                      ...
                      <a href="#" class="btn btn-success">Deposit DAI</a>
                    </div>

                    {/* Dapp Running */}
                    <div class="running d-none">
                      <p class="card-text">You are currently earning with <span class="winner">AAVE</span>.</p>
                      <div class="media">
                        <img src="https://app.compound.finance/compound-components/assets/asset_AAVE.svg" class="col-4" alt="..."/>
                        <div class="media-body">
                          <h5 class="mt-0">AAVE</h5>
                          <div class="alert alert-info">2.86 %APR</div>
                        </div>
                      </div>
                      <div class="media border-top py-3">
                        ...
                        <div class="media-body">
                          ...
                          <div class="alert alert-success">2.86 %APR</div>
                        </div>
                      </div>
                      <h5 class="alert alert-primary">Total Earnings <span class="earnings">.05</span> DAI</h5>
                      <a href="#" class="mx-2 btn btn-info">Rebalance</a>
                      <a href="#" class="mx-2 btn btn-danger">Withdraw</a>
                    </div>

                    {/* Rebalancing */}
                    <div class="rebalancing d-none">
                      <p class="alert alert-info">Checking for the best Yield.</p>
                      ...
                      <a href="#" class="btn btn-primary mt-3 d-none">Continue</a>
                    </div>
                    ...
                    <div class="withdraw ">
                      ...
                      <a href="#" class="btn btn-danger">Withdraw DAI</a>
                    </div>
